...
db.session.add(Photo('images/photo1.png', 'photo1', datetime.datetime.now() ))
db.session.add(Photo('images/photo2.png', 'photo2', datetime.datetime.now() ))
db.session.add(Photo('images/photo3.png', 'photo3', datetime.datetime.now() ))
db.session.add(Photo('images/photo4.png', 'photo4', datetime.datetime.now() ))
db.session.add(Photo('images/photo5.png', 'photo5', datetime.datetime.now() ))
db.session.add(Photo('images/photo6.png', 'photo6', datetime.datetime.now() ))
db.session.add(Photo('images/photo7.png', 'photo7', datetime.datetime.now() ))
db.session.add(Photo('images/photo8.png', 'photo8', datetime.datetime.now() ))
db.session.commit()
